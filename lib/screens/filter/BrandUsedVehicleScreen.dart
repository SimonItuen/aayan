...
class BrandUsedVehicleScreen extends StatefulWidget {
  static final String routeName = '/brand-used-vehicle';

  @override
  _BrandUsedVehicleScreenState createState() =>
      _BrandUsedVehicleScreenState();
}

class _BrandUsedVehicleScreenState extends State<BrandUsedVehicleScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    List<BrandModel> brandList = _appProvider.getUsedBrandList();
    return Scaffold(
      appBar: AppBar(
