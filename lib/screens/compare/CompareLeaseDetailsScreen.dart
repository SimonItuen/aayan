...
class CompareLeaseDetailsScreen extends StatefulWidget {
  ...
  @override
  _CompareLeaseDetailsScreenState createState() =>
      _CompareLeaseDetailsScreenState();
}
      ...
      child: Scaffold(
            ...
            Padding(
              ...
              child: AppTransparentButton(
                  ...
                  onPressed: () {
                    ...
                    Provider.of<AppProvider>(context, listen: false)
                        .setCompareLeaseVehicleList(
                            _appProvider.getCompareLeaseVehicleList());
                    Navigator.of(context).maybePop();
                  },
                  child: Text(
        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              Container(
                height: _appProvider.getCompareLeaseVehicleList().length < 3
                ...
                child: Row(
                  children: [
                    for (int i = 0;
                        i < _appProvider.getCompareLeaseVehicleList().length;
                        i++)
                      Expanded(
                        child: Row(
                          children: [
                                  ...
                                  Container(
                                      ...
                                      child: _appProvider
                                          ...
                                          ? CachedNetworkImage(
                                              ...
                                              imageUrl:
                                                  '${_appProvider.getCompareLeaseVehicleList()[i].imageName}',
                                              fit: BoxFit.contain,
                  ...
                  Row(
                    ...
                    children: [
                      for (int i = 0;
                        ...
                        Expanded(
                            child: Text(
                          '${_appProvider.getCompareLeaseVehicleList()[i].brand}',
                  ...
                  Row(
                    ...
                    children: [
                      for (int i = 0;
                        ...
                        Expanded(
                            child: Text(
                          '${_appProvider.getCompareLeaseVehicleList()[i].model}',
                          textAlign: TextAlign.center,
                          style: TextStyle(
                              fontSize: 14,
                              color: Colors.black,
                  ...
                  Row(
                    ...
                    children: [
                      for (int i = 0;
                        ...
                        Expanded(
                            child: Text(
                          '${_appProvider.getCompareLeaseVehicleList()[i].year}',
                          textAlign: TextAlign.center,
                          style: TextStyle(
                              fontSize: 14,
                              color: Colors.black,
                  ...
                  Row(
                    ...
                    children: [
                      for (int i = 0;
                        ...
                        Expanded(
                            child: Text(
                          '${!_appProvider.getCompareLeaseVehicleList()[i].feature.trim().startsWith('null')?_appProvider.getCompareLeaseVehicleList()[i].feature:''}',
                          textAlign: TextAlign.center,
                          style: TextStyle(
                              fontSize: 14,
                              color: Colors.black,
